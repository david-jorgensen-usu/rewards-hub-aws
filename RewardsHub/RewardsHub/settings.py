"""
Django settings for RewardsHub project.
...
SECRET_KEY = "django-insecure-^h5-#bx8-^xj&pj228^hz&xn@5wb#^vwz^zkdf)=2*2luejd=l"
...
WSGI_APPLICATION = "RewardsHub.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "rewardshub_db"),
        "USER": os.getenv("DB_USER", "rewardshub_user"),
